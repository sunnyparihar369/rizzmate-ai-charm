...
const Dashboard = () => {
  ...
  const analyzeConversation = async () => {
    ...
    try {
      ...
      if (screenshot) {
        // For screenshot analysis, we'll use a simulated analysis for now
        analysisPrompt = `Analyze this dating app conversation screenshot and generate a ${selectedTone} reply. The conversation appears to be casual and friendly. Generate an engaging response that matches the ${selectedTone} tone.`;
      } else {
...
Conversation: ${conversationText || "Screenshot uploaded (simulated analysis)"}
